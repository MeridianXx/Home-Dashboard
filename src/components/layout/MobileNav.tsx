...
export default function MobileNav() {
  ...
  return (
    <nav className="md:hidden fixed z-50" style={{ bottom: "20px", left: 0, right: 0, display: "flex", justifyContent: "center", WebkitTransform: "translateZ(0)", willChange: "transform" }}>
      <div
